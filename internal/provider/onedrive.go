...
func NewOneDrive(cfg config.OneDriveConfig) (*OneDriveProvider, error) {
	if err := cfg.Validate(); err != nil {
		return nil, err
	}
	return &OneDriveProvider{config: oauth2.Config{
...
func (p *OneDriveProvider) AuthURL(req AuthRequest) (string, error) {
...
func (p *OneDriveProvider) Exchange(ctx context.Context, req ExchangeRequest) (*model.TokenSet, error) {
...
func (p *OneDriveProvider) Refresh(ctx context.Context, token *model.TokenSet) (*model.TokenSet, error) {
