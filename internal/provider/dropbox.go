...
func NewDropbox(cfg config.DropboxConfig) (*DropboxProvider, error) {
	if err := cfg.Validate(); err != nil {
		return nil, err
	}
	return &DropboxProvider{config: oauth2.Config{
...
func (p *DropboxProvider) AuthURL(req AuthRequest) (string, error) {
...
func (p *DropboxProvider) Exchange(ctx context.Context, req ExchangeRequest) (*model.TokenSet, error) {
...
func (p *DropboxProvider) Refresh(ctx context.Context, token *model.TokenSet) (*model.TokenSet, error) {
